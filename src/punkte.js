// Punktesystem — WORTGLEICHE Kopie der Logik aus der Hauptseite
// (aspl-rennkalender/src/utils/punkte.js), damit die Meisterschaftsstaende
// hier exakt dieselben Zahlen ergeben. Nur reine Rechenlogik, keine Daten:
// die Renndaten selbst werden zur Laufzeit von der Hauptseite geladen.
//
// Solo/Team: DTM-System (P1-P15 + Quali-Bonus P1-P3).
// Endurance: FIA-Endurance-System (kein Quali-Bonus).
